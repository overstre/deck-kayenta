...
export const UPDATE_OPENTSDB_METRIC_DESCRIPTOR_FILTER = 'update_opentsdb_metric_descriptor_filter';
...
export const UPDATE_OPENTSDB_QUERY_PAIRS = 'update_opentsdb_query_pairs';
